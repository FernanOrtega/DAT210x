...
def processUser(i):
    ...
    print centroids
    ax.scatter(x = centroids[:, 1], y = centroids[:, 0], c = 'r', marker = 'x', s = 100)
    
    #showandtell(title='Centroids of user 1')  # TODO: Comment this line out when you're ready to proceed
...
#
for i in range(0,9): processUser(i)
