...
#
y = pd.read_csv('Datasets/face_labels.csv',header=None).iloc[:,0]
...
# test_size to 0.15 (15%). Your labels are actually passed in as a series
...
# label_test).
#
  print "k=",i," -> ",knn.score(data_test, label_test)
